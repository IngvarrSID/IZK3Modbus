...
public class TimerActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (status.equals("Данные получены")) {
            ...
            izkModbusGUI.getHumidityField().setText(String.format("Влажность: %.1f %%", query.getHumidity()));
            ...
            izkModbusGUI.getErrorField().setText(String.format("Инструмент. погрешность: %.1f у.е.", query.getError()));
