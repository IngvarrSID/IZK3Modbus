...
public class RefreshRegulatorButtonRunnable implements Runnable{

    private final Query query;
    private final ModbusReader modbusReader;
    private final IZKModbusGUI izkModbusGUI;

    public RefreshRegulatorButtonRunnable(Query query, ModbusReader modbusReader, IZKModbusGUI izkModbusGUI) {
        this.query = query;
    ...
    private void processAction(){
        try {
            izkModbusGUI.getRefreshRegulatorButton().setEnabled(false);
            ...
            izkModbusGUI.getRefreshRegulatorButton().setEnabled(true);
        } catch (Exception ex){
            ex.printStackTrace();
