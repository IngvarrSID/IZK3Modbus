...
public class RefreshSettingsButtonRunnable implements Runnable{

    private final Query query;
    private final ModbusReader modbusReader;
    private final IZKModbusGUI izkModbusGUI;

    public RefreshSettingsButtonRunnable(Query query, ModbusReader modbusReader, IZKModbusGUI izkModbusGUI) {
        this.query = query;
    ...
    private void processAction(){
        ...
        izkModbusGUI.getRefreshSettingsButton().setEnabled(false);
